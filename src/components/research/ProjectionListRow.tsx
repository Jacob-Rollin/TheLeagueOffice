  ...
  return (
    <li className={cn("absolute left-0 top-0 w-full select-none", meta.row)} style={style}>
      <button
        ...
        className="grid h-full w-full cursor-pointer grid-cols-[2.5rem_minmax(0,1fr)_minmax(7.5rem,0.95fr)_3.5rem] items-center gap-x-2 border-b border-slate-100 px-3 text-left transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary/40 sm:grid-cols-[2.75rem_minmax(12rem,1.5fr)_minmax(8.5rem,1fr)_4rem] sm:gap-x-4 sm:px-4"
      >
